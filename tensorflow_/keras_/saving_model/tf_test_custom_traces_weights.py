...
class TestCustomTracesWeights(TestCase):
    ...
    def test_with_traces_restore_class(self) -> None:
        ...
        model.save(_save_path)
        model_reloaded: CustomModelWithWeights = \
        ...
        # noinspection PyUnresolvedReferences
        self.assertTrue((model_reloaded.shift == model.shift).numpy())
        self.assertEqual(tuple(model_reloaded.weights_.shape.as_list()), tuple(model.weights_.shape.as_list()))
